                ...
                <Box display={"flex"} justifyContent={"end"}>
                    <Skeleton startColor="rgba(256, 256, 256, .1)" endColor="rgba(256, 256, 256, .2)" rounded={"7px"} isLoaded={loaderUsd}>
                        ...
                        mr={"0"} pl={"0"} variant={"unstyled"} w={"fit-content"} min={0} >
                            <NumberInputField w={{base: "150px", md: "fit-content"}} px={"0"} mr={"0"} pl={"0"} placeholder="0" textAlign={"end"} border={"0"} _focus={{border: "0", outline: "0"}} _hover={{bg: "transparent"}} height={"fit-content"} pb={"8px"} pt={"10px"} fontSize={{base: "20px", md: "24px"}} />
                        </NumberInput>
                    </Skeleton>
                </Box>
            }
